...
#import "GetIpViewController.h"

@interface GetIpViewController ()
...
NSString *ips,*ip,*detailed,*area_style_areanm,*op;

@implementation GetIpViewController
...
-(void)startIP{
    ...
    op = [NSString stringWithFormat:@"%@", operatorsDic];
...
-(void) showIpData{
    ...
    self.dataL.text = [self.dataL.text stringByAppendingString:op];
    self.dataL.text = [self.dataL.text stringByAppendingString:@"\n\n\t"];
